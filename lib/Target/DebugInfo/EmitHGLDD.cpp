...
/// Wraps the shared `circt::debuginfo::bestLocation` helper. Source ("HGL",
/// emitted=false) vs emitted ("HDL", emitted=true) locations both go through
/// the same loc-tree walk; HGLDD does not memoise existence checks.
